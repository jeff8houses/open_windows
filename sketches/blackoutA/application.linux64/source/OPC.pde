...
public class OPC
{
  ...
  void ledRing(int index, int count, float x, float y, float radius, float angle, boolean inverted)
  {
    float pi = PI;
    if(inverted == true)
      pi *= -1;
  ...
  void ledRingGrid(int screenWidth, int screenHeight, int numPixels)
  {    
